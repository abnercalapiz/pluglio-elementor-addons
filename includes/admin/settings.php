...
class Pluglio_Settings {
    ...
    private function get_available_widgets() {
        return [
            ...
            'toggle_search' => [
                'name' => __('Toggle Search', 'pluglio-elementor-addons'),
                'description' => __('A modern search widget with toggle functionality. Click to reveal/hide the search form with smooth animations and customizable styling.', 'pluglio-elementor-addons')
            ],
            'conditional_display' => [
